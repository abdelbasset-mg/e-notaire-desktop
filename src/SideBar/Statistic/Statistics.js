              ...
              <div className="statstic-container">
                <div className="statistic">
                  <div className="l1">
                    <div className="new">
                      {" "}
                      <div className="b1"> •</div> الزبائن القدامى
                    </div>
                  ...
                  <div className="l2">
                    <div className="old">
                      {" "}
                      <div className="b2"> • </div> الزبائن الجدد{" "}
                    </div>
                ...
                {file.map((data, index) => {
                  return (
                    <div className="ligne2">
                      ...
                      <div className="lit2 centered-element">
                        {data.status}{" "}
                      </div>
                    </div>
                  );
