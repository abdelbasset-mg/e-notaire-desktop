            ...
            <div className="flex flex-row">
              <div className="info-setting">
                <form>
                  <div className="input-info">
                    <label className="label" for="deskName">
                      اسم المكتب
                    </label>
                    <input
                      className="input-info-1"
                      type="text"
                      name="deskName"
                      id="deskName"
                      placeholder="طرف"
                  ...
                  <div className="input-info">
                    <label className="label" for="wilaya">
                      الولاية{" "}
                    </label>
                    <input
                      className="input-info-1"
                  ...
                  <div className="input-info">
                    <label className="label" for="ragional">
                      {" "}
                      الغرفة الجهوية
                    </label>
                    <input
                  ...
                  <div className="input-info">
                    <label className="label" for="seller">
                      مولد البائع
                    </label>
                    <input
                      className="input-info-1"
                  ...
                  <div className="input-info">
                    <label className="label" for="buyer">
                      مولد المشتري
                    </label>
                    <input
                      className="input-info-1"
                  ...
                  <div className="input-info">
                    <label className="label" for="rooms">
                      عدد الغرف
                    </label>
                    <input
                      className="input-info-1"
              ...
              <div className="password-2 ">
                <div className="password  flex flex-col">
                  ...
                  <div>
                    <div className="Pass flex flex-col">
                      <label className="label-2" for="currentPassword">
                        كلمة المرور الحالية
                      </label>
                    ...
                    <div className="Pass flex flex-col">
                      <label className="label-2" for="newPassword">
                        كلمة المرور الجديدة
                      </label>
                      <div className="flex flex-row eye">
                        <input
                    ...
                    <div className="Pass flex flex-col">
                      <label className="label-2" for="confirmNewPassword">
                ...
                <div className="savePass ">
                  <button className="save bg-[#284A68] text-white">
                    {" "}
                    تغيير كلمة المرور
                  </button>
                </div>
